...
A1 = 'surgery'
# S2 = ['tumor_stage_postTrt', 'tumor_size_cm_postTrt',  'postTrt_numPosLymphNodes',  'postTrt_lymph_node_status', 'RCB', 'other_treatment', 'metastasis', 'metastasis_months', 'trastuzumab']

#variance
S2 = ['postTrt_numPosLymphNodes', 'metastasis_months', 'tumor_size_cm_postTrt']

#cross validation
# S2 = ['postTrt_numPosLymphNodes']

H2 = H1 + [A1] + S2

A2 = 'chemotherapy'
# S3 =  ['anthracycline', 'taxane',
...
#variance
S3 = ['metastasis_months_1', 'pCR', 'near_pCR', 'metastasis_1', 'taxane']

#cross validation
# S3 = ['metastasis_months_1']

H3 = H2 + [A2] + S3

A3 = 'hormone_therapy'
# S4 = ['tamoxifen', 'aromatase_inhibitor',  'fulvestrant', 'anastrozole','letrozole', 'anti_estrogen', 'estrogen_receptor', 'anti_HER2', 'other_treatment', 'metastasis_2', 'metastasis_months_2'
#     ]


#variance
S4 = ['metastasis_months_2', 'estrogen_receptor', 'letrozole', 'aromatase_inhibitor', 'tamoxifen', 'anti_estrogen', 'other_treatment']

# cross validation
# S4 = ['metastasis_months_2', 'estrogen_receptor', 'letrozole']
...
Y = [ 'OS','died_from_cancer_if_dead', 'RFS', 'DFS']
